...
class Textfield extends Component {
  ...
  _onInputMeasured(left, top, width, height) {
    ...
    const underlineWidth = width + (this.props.icon ? 32 : 0);
    this.refs.underline.updateLineLength(underlineWidth, () => {
  ...
  render() {
    ...
    return (
        <View style={this.props.style} >
            ...
            {this.props.icon &&
              <View
                style={{
                  ...
                  width: 32,
                  marginBottom: this.props.textInputStyle.marginBottom,
                  paddingTop: 2,
                  paddingBottom: 2,
          ...
          />
          {(!this.props.hideNoError || this.props.error) &&
              <Text
